...
def reinforcement_learning_activity():
    ...
    print("\nReflection:")
    print (" How did the model's response improve with feedback?")
...
def role_based_prompt_activity():
    ...
    item = input(f"Enter a specific {category} topic 9e.g, 'photosynthesis' for science): ").strip()
    ...
    print("1. How did the AI's response differ between the teachter's and expert's perspective?")
    print("2. how can role-based prompts help tailor Ai responses for different context?")
def run_activity():
